...
class ProductDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => VariationCubit(product),
      child: Scaffold(
            ...
            children: [
              ...
              BlocBuilder<VariationCubit, VariationState>(
                builder: (context, state) {
                  return TProductImageSlider(product: product, allImages: state.allProductImages,selectedImage: state.selectedImageUrl, onImageSelected: (imageUrl){
